...
public class PutAPITest extends testBase {
	...
	public void putApiTest() throws JsonGenerationException, JsonMappingException, IOException, JSONException {
		...
		Users users = new Users("morpheus", "zion resident"); //expected users object
		...
		//Assert.assertTrue(users.getUpdatedAt().equals(usersRespObj.getUpdatedAt()));
		
		System.out.println(usersRespObj.getId());
		System.out.println(usersRespObj.getCreatedAt());
		System.out.println(usersRespObj.getUpdatedAt());
